...
/**
 * EventManager.java is an entity class that contain all the needed methods of
 * an event interface.
 * 
 * @author Dennis
 * @version 1.0
...
public interface EventManager<E> {
    ...
    boolean addEvent(int eventSeqNum, String eventTitle, String eventVenue, String eventDetails, String eventDate,
            int durationInDay);
    ...
    boolean editEvent(String id, String eventTitle, String eventVenue, String eventDetails, String eventDate,
            int durationInDay);
}
