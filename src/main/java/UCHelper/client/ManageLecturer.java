...
public class ManageLecturer {
    ...
    static void display() {
         ...
         * System.out.println("if want going back to menu enter 'y'"); pick =
         * myObj.next().charAt(0);
         * 
         * }while(pick == 'n');
         */
    ...
    static void CheckLecturer() {
        ...
        do {
            ...
            // lectChck.add(new
            // Lecturer(firstName,lastName,username,password,emailId,phoneNo);
            l.setfirstName(firstName);
            l.setlastName(lastName);
            l.setUserName(username);
            l.setPassword(password);
    ...
    static void CheckLecturer2() {
        /*
         * char pick; do{ //SetInterface<String> lectChck = new Set<>() {};
         * System.out.println("Enter your first name:"); String firstName =
         * myObj.next();
         * 
         * System.out.println("Enter your last name:"); String lastName = myObj.next();
         * 
         * System.out.println("Enter your username:"); String username = myObj.next();
         * 
         * System.out.println("Enter your email:"); String emailId = myObj.next();
         * 
         * System.out.println("Enter your contact:"); String phoneNo = myObj.next();
         * 
         * //for(Lecturer in your lecturer set){compare the lecturer ID} for (int i = 0;
         * i < 10; i++) { lecturer.getfirstname;
         * 
         * } System.out.println("Does the Set contains 'Geeks'? " +
         * lecturer.contains(firstName));
         * 
         * // Check for "4" in the set System.out.println("Does the Set contains '4'? "
         * + lecturer.contains(lastName));
         * 
         * // Check if the Set contains "No"
         * System.out.println("Does the Set contains 'No'? " +
         * lecturer.contains(username)); // Check if the Set contains "No"
         * System.out.println("Does the Set contains 'No'? " +
         * lecturer.contains(emailId)); // Check if the Set contains "No"
         * System.out.println("Does the Set contains 'No'? " +
         * lecturer.contains(phoneNo));
         * 
         * System.out.println("if you wish to continue check lecturer enter 'y'");
         * System.out.println("if want going back to menu enter 'n'"); pick =
         * myObj.next().charAt(0); if (pick == 'n') display(); }while(pick == 'y');
         **/}
}